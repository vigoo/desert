...
import io.github.vigoo.desert.{BinaryCodec, FieldAdded, FieldMadeOptional, FieldMadeTransient, TransientConstructor, TransientField}
...
case class TestModel1(byte: Byte,
                      short: Short,
                      int: Int,
                      long: Long,
                      float: Float,
...
object TestModel1 {
  ...
  object ListElement2 {
    ...
    final case class Second(uuid: UUID, desc: Option[String], @TransientField(None) cached: Option[String]) extends ListElement2
  ...
  val value1: TestModel1 =
    TestModel1(
      ...
      option = Some(Map(
        ...
        "second" -> ListElement2.Second(UUID.fromString("0ca26648-edee-4a2d-bd88-eebf92d19c30"), None, Some("cached")),
        "third" -> ListElement2.Second(UUID.fromString("0ca26648-edee-4a2d-bd88-eebf92d19c30"), Some("some description"), None),
      ))
    )
}